...
let err;
var fs = require('fs');
fs.writeFile('array.json', JSON.stringify(byPrice,undefined,1), function (err:any) { console.log(err ? 'Error :'+err : 'ok') });
fs.writeFile('text.txt', JSON.stringify(byPrice), function (err:any) { console.log(err ? 'Error :'+err : 'ok') });
